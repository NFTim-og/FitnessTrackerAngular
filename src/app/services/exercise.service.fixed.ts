...
export class ExerciseService {
  ...
  loadExercises(params: PaginationParams): Observable<void> {
    ...
    // For debugging, make a direct fetch request
    fetch(`${this.apiUrl}?page=${params.page}&limit=${params.perPage}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem('fitness_tracker_token')}`
      }
    })
    ...
    .then(data => {
      ...
      // Use the direct fetch response to update the subjects
